const carSelect = document.querySelector("#brand-name");
const modelSelect = document.querySelector("#brand-model");
...
function calculateTotal() {
  ...
  if (document.getElementById("oil_input").checked) {
    total += oilChange * multiplier;
  }
  if (document.getElementById("filter_input").checked) {
    total += filter * multiplier;
  }
...
modalForm.addEventListener("submit", async (e) => {
  ...
  const carMake = modalForm.querySelector("#brand-name").value;
  const carModel = modalForm.querySelector("#brand-model").value;
